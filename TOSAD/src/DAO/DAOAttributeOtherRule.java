...
public class DAOAttributeOtherRule extends ConnectionConfiguration {
	...
	public void wijzigAttributeOtherRule(String script, int ruleID) {
		String query = "update ATTRIBUTEOTHERRULE set GENERATEDCODE = ? where RULEID = ?";
