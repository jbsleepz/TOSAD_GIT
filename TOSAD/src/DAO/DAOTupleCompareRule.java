...
public class DAOTupleCompareRule extends ConnectionConfiguration {
	...
	public void wijzigTupleCompareRule(String script, int ruleID) {
		String query = "update TUPLECOMPARERULE set GENERATEDCODE = ? where RULEID = ?";
