...
public class DAOInterEntityCompareRule extends ConnectionConfiguration {
	...
	public void wijzigInterEntityCompareRule(String script, int ruleID) {
		String query = "update INTERCOMPARERULE set GENERATEDCODE = ? where RULEID = ?";
