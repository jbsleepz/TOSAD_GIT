...
public class DAOModify extends ConnectionConfiguration {
	...
	public void wijzigModifyRule(String script, int ruleID) {
		String query = "update MODIFYRULE set GENERATEDCODE = ? where RULEID = ?";
