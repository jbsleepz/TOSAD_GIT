...
public class DAOAttributeListRule extends ConnectionConfiguration {
	...
	public void wijzigAttributeListRule(String script, int ruleID) {
		String query = "update ATTRIBUTELISTRULE set GENERATEDCODE = ? where RULEID = ?";
