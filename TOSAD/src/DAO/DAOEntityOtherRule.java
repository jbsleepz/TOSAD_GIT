...
public class DAOEntityOtherRule extends ConnectionConfiguration {
	...
	public void wijzigEntityOtherRule(String script, int ruleID) {
		String query = "update ENTITYOTHERRULE set GENERATEDCODE = ? where RULEID = ?";
